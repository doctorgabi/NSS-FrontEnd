...
var app = express();
mongoose.connect('mongodb://localhost/blogger');//this line tells node where your server's at
//it will dynamically create the database and all the fields for you on the fly.
